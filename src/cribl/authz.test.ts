...
describe('the sentence', () => {
  ...
  it('names the method and the path, which is what an admin would grant', () => {
    const text = denialReason('onboarding_stack.remove', denial)
  ...
  it('quotes what Cribl actually said', () => {
    expect(denialReason('onboarding_stack.remove', denial)).toContain('Not authorized or licensed to perform this action.')
  })
