  ...
  for (const [name, value] of Object.entries(copy)) {
    if (typeof value === 'string') out.push(value)
      ...
      const tries: unknown[][] = {
        ...
        upgradeDroppedSourcesSentence: [[['in_gno_syslog']], [['in_gno_syslog', 'in_gno_sample']]],
        upgradeDroppedSentence: [['0.2.1', ['in_gno_syslog']], ['0.2.1', ['in_gno_syslog', 'gno_syslog', 'out_gno_lake']]],
